            ...
            <div class="card-body">
                ...
                <div class="w-full flex flex-col">
                    <div class="stat bg-transparent">
                        ...
                        <div class="stat-title text-gray-900 font-bold">Total Star</div>
                        <div class="stat-value text-primary">{stargazers_count}</div>
                    </div>
                </div>

            </div>
            <div class="card-actions flex justify-between">
                {language ? <div class="badge mx-2 badge-error">{language}</div> : <div class="badge mx-2 badge-error">Other</div>}
                <a href={html_url} target="_blank">
                    <button class="bg-green btn border-0 rounded-xl">Visit</button>
                </a>
            </div>
        </div>
    )
